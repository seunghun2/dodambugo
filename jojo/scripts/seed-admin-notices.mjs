...
const officialNotices = [
  ...
  },
  {
    ...
    content: `<p>안녕하세요. 부고온 파트너입니다.</p><p>파트너 회원 간 추천인 코드 혜택 안내해 드립니다.</p><p>1. 추천인 코드 확인<br />- 메인 화면 및 내 정보에서 본인의 4자리 추천 코드를 확인하실 수 있습니다.</p><p>2. 추천 혜택 적용 기준<br />- 신규 파트너가 가입 시 내 4자리 추천 코드를 입력하면 추천인(나)에게 추천 적립금이 지급됩니다.</p><p>파트너 여러분의 많은 이용 바랍니다.</p><p>감사합니다.</p>`,
    is_fixed: false,
  },
  {
...
async function seedNotices() {
  console.log('불필요 공지 삭제 및 추천인 단일 지급 반영 5종 시딩 시작...');
  ...
  if (error) {
    ...
    console.log(`🎉 성공적으로 공지사항 5건이 DB에 최종 업데이트되었습니다!`);
  }
}

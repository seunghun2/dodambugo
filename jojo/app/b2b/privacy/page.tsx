            ...
            <main className="legal-content">
                <section className="terms-section">
                    <p className="privacy-intro">
                        부고온(이하 "회사")는 B2B 파트너(이하 "파트너")의 개인정보를 매우 중요하게 생각하며, "개인정보 보호법", "정보통신망 이용촉진 및 정보보호 등에 관한 법률" 등 관련 법규를 준수하고 있습니다. 회사는 본 개인정보처리방침을 통해 수집되는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 안전하게 보호하기 위해 어떠한 조치를 취하고 있는지 알려드립니다.
                    </p>
                </section>

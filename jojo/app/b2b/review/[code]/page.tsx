...
import '../../../review/[code]/review.css';

export default function B2BBurialReviewPage() {
    ...
    const handleNext = () => {
        ...
        router.push(`/b2b/review/${reviewCode}?step=2`);
        window.scrollTo(0, 0);
    };

    const handleBack = () => {
        router.push(`/b2b/review/${reviewCode}`);
        window.scrollTo(0, 0);
    };
    ...
    if (loading) {
        return <div className="review-container b2b-theme"><div className="review-loading">불러오는 중...</div></div>;
    }

    if (!authorized) {
        return (
            <div className="review-container b2b-theme">
            ...
            <div className="review-card">
                ...
                <div className="review-place">
                    <div className="review-place-label">
                        {hasTwoPlaces ? (step === 1 ? '1차 장지 만족도' : '2차 장지 만족도') : '이용하신 장지'}
                    </div>
                ...
                <div className="review-consent-text" onClick={() => setShowConsentModal(true)}>
                    후기 활용 및 이용 약관에 동의합니다. <span className="consent-arrow">›</span>
                </div>
            </div>
                ...
                <div className="consent-overlay" onClick={() => setShowConsentModal(false)}>
                    <div className="consent-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="consent-modal-body">
                            ...
                            <p>장례 정보 서비스 및 부고온의 투명한 장례 데이터 구축, 장지 만족도 후기 제공</p>
                            <br />
                            <p><strong>보유 기간</strong></p>
                            <p>후기 삭제 요청 시까지</p>
                            <br />
                            <p>후기 등록 시 위 내용에 동의한 것으로 간주됩니다. 작성하신 후기는 부고온 장례 만족도 서비스에서 다른 이용자에게 제공될 수 있습니다.</p>
                        </div>

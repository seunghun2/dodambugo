...
const b2bFaqData: FAQItem[] = [
  {
    ...
    answer: '부고온 파트너 웹/앱 내 [부고 관리] 메뉴에서 해당하는 부고장의 [편집]을 클릭하신 후, 하단의 화환 판매 노출 설정 스위치가 켜져 있는지 확인해 주세요.',
  },
  {
    question: '부고장 내에 부의금 보내기에 카드결제를 안보이게 할 수 있나요?',
    answer: '네, 가능합니다. 부고장 작성/수정 시 [조의금 설정] 옵션에서 계좌 입금 전용으로 설정하시면 카드 결제 버튼이 숨겨집니다.',
  },
  {
    question: '부고장 내에 상주 자리 앞부분을 공란으로 맞추려면 어떻게 해야하나요?',
    answer: '상주 이름 입력란에 공백(스페이스바)을 입력하거나, 관계 선택을 [직접 입력]으로 설정하신 후 빈칸으로 저장하시면 공란으로 표시됩니다.',
  },
  {
    question: '계좌번호 입력을 했는데 부고장(부의금보내기)에 안보여요',
    answer: '입력하신 계좌번호의 예금주 실명 인증이 완료되었는지 확인해 주세요. 인증되지 않은 계좌는 보안 정책상 부고장에 노출되지 않습니다.',
  },
  {
    question: '부고온 고객센터가 어떻게 되나요?',
    answer: '부고온 고객센터 대표번호는 1544-0000 이며, 평일 09:00 ~ 18:00 (점심시간 12:00 ~ 13:00 제외) 운영됩니다. 1:1 문의를 남겨주시면 빠르게 답변해 드립니다.',
  },
  {
    question: '내 정보에 고유번호는 무엇인가요?',
    answer: '파트너님 계정에 부여된 고유 식별 번호로, 추천인 등록 및 정산 문의 시 본인 확인용으로 사용됩니다. [설정] > [내 정보]에서 확인하실 수 있습니다.',
  },
  {
    question: '적립금은 언제 지급되나요?',
    answer: '화환 주문 및 이벤트 적립금은 배송 완료/조건 충족 후 24시간의 유예 기간을 거쳐 [환급 가능 적립금]으로 전환되어 즉시 출금 신청이 가능합니다.',
  },
  {
    question: '환급신청을 했는데 언제 지급되나요?',
    answer: '부고온의 환급 시스템은 자동 펌뱅킹으로 작동하여, 출금 신청 즉시 지정하신 파트너 계좌로 실시간 자동 입금됩니다.',
  },
  {
    question: '환급신청 시 인증 과정에서 오류가 나와요',
    answer: '본인 명의의 휴대폰 인증 및 계좌 예금주명이 회원가입 시 등록된 실명과 일치하는지 확인해 주세요. 3.3% 원천징수 신고를 위해 명의 일치가 필수적입니다.',
  },
  {
    question: '장례식장 별로 다른 화환이 나와요. 화환 상품 추가 가능한가요?',
    answer: '지역별 화환 배송 협력업체 및 장례식장 규정에 따라 노출 상품이 다를 수 있습니다. 특정 상품 추가를 원하시면 고객센터 1:1 문의로 신청해 주시기 바랍니다.',
  },
];

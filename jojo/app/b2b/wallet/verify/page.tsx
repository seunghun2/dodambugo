        ...
        <div className={styles.page}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.termsArea}>
                    ...
                    {/* 전체 동의하기 박스 */}
                    <div
                        className={`${styles.allAgreeBox} ${agree1 && agree2 ? styles.allAgreeBoxActive : ''}`}
                        onClick={handleAllAgree}
                    >
                        <div className={`${styles.checkbox} ${(agree1 && agree2) ? styles.checkboxChecked : ''}`}>
                            {(agree1 && agree2) && (
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                                    <polyline points="20 6 9 17 4 12" />
                                </svg>
                    ...
                    <div className={styles.modalContainer} onClick={(e) => e.stopPropagation()}>
                        <div className={styles.modalHeader}>
                            <h3 className={styles.modalTitle}>
                                {showModal === 'privacy' ? '개인정보 수집 및 이용안내' : '마케팅 수신 동의 약관'}
                            </h3>

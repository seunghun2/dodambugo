...
const getReligionType = (religion?: string): ReligionType => {
    if (religion === '기독교' || religion === 'christian') return 'christian';
    if (religion === '천주교' || religion === 'catholic') return 'catholic';
    if (religion === '불교' || religion === 'buddhist') return 'buddhist';
    return 'general';
};
...
export default function CardContent({ bugo, bugoId }: CardContentProps) {
    ...
    const getDisplayMessage = () => {
        ...
        return defaultMessages[religionType].map(t => replaceDeceased(t));
    };
    ...
    return (
        <div className="thanks-page">
            ...
            {/* 컨텐츠 */}
            <div className="thanks-content" style={{ paddingTop: '210px' }}>
                {/* 메시지 카드 */}
                <div className="thanks-card">
                    <h1 className="thanks-title">삼가 감사 인사 드립니다</h1>

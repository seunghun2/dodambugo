// 개발용 DB 테스트 데이터 생성 스크립트

const { createClient } = require('@supabase/supabase-js');

// 개발용 Supabase
const supabaseUrl = 'https://mnlyqhrjnpbkleenmszm.supabase.co';
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1ubHlxaHJqbnBia2xlZW5tc3ptIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc2NjgwMzMsImV4cCI6MjA4MzI0NDAzM30.pHsL9NIfHo_05euTkIiZOX0K4NuLqCBDFZK5mA_H4WY';
...
async function main() {
    console.log('📝 개발 DB에 테스트 데이터 30개 생성 중...');

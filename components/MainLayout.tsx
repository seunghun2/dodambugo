...
export default function MainLayout({ children }: MainLayoutProps) {
    ...
    // 홈, 뷰 페이지, 완료 페이지, 미리보기 페이지, 템플릿 변경 모드, 어드민에서는 헤더 숨김 (각자 관리)
    const hideHeader = pathname === '/' || pathname.startsWith('/view/') || pathname.startsWith('/create/complete/') || pathname.startsWith('/create/preview/') || pathname.startsWith('/admin') || isChangeMode;

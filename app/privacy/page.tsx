            ...
            <main className="legal-content">
                <section className="terms-section">
                    <p className="privacy-intro">
                        마음부고(이하 "회사")는 이용자의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법규를 준수하고 있습니다.
                ...
                <section className="terms-section">
                    ...
                    <ul>
                        ...
                        <li><strong>부의금 카드결제 시 수집항목:</strong> 결제자 성명, 결제자 연락처, 결제 금액, 결제 일시 (카드번호 등 결제 상세 정보는 PG사가 직접 처리하며 회사는 저장하지 않음)</li>
                        <li><strong>장지 이용 후기 수집항목:</strong> 장지명, 상주명, 별점, 이용 소감, 사진(선택)</li>
                    ...
                    <ul>
                        ...
                        <li>장지 이용 후기 작성 시 이용자가 직접 입력</li>
                ...
                <section className="terms-section">
                    ...
                    <h3>다. 부의금 카드결제 서비스</h3>
                    <ul>
                        <li>부의금 카드결제 처리 및 송금</li>
                        <li>결제 내역 조회 및 관리</li>
                        <li>환불/취소 처리</li>
                        <li>부정 결제 방지 및 본인 확인</li>
                    </ul>

                    <h3>라. 장지 이용 후기</h3>
                    <ul>
                        <li>장지(장례 시설) 이용 경험 수집 및 후기 제공</li>
                        <li>장례 정보 서비스 품질 개선</li>
                        <li>이용자 후기를 통한 시설 정보 투명성 향상</li>
                    </ul>
                ...
                <section className="terms-section">
                    ...
                    <ul>
                        ...
                        <li><strong>부의금 결제 기록:</strong> 5년 (전자상거래법 및 전자금융거래법에 따라 보관)</li>
                        <li><strong>장지 이용 후기:</strong> 후기 삭제 요청 시까지 보관 (이용자가 삭제 요청 시 즉시 삭제)</li>
                ...
                <section className="terms-section">
                    ...
                    <h3>가. 부의금 카드결제 관련 제3자 제공</h3>
                    <p>회사는 부의금 카드결제 서비스 제공을 위해 아래와 같이 개인정보를 제3자에게 제공합니다:</p>
                    <ul>
                        <li><strong>제공받는 자:</strong> 결제대행사(PG사)</li>
                        <li><strong>제공하는 항목:</strong> 결제자 성명, 결제 금액, 주문번호</li>
                        <li><strong>제공 목적:</strong> 카드결제 처리 및 송금 대행</li>
                        <li><strong>보유 기간:</strong> 결제 처리 완료 후 5년 (전자상거래법)</li>
                    </ul>
                </section>
                ...
                <section className="terms-section">
                    ...
                    <ul>
                        ...
                        <li>2026년 3월 5일 개정: 부의금 카드결제 관련 수집항목, 이용목적, 보유기간, 제3자 제공 내용 추가</li>
                        <li>2026년 3월 10일 개정: 장지 이용 후기 관련 수집항목, 이용목적, 보유기간 추가</li>
                    </ul>
                </section>
            </main>
        </div>
